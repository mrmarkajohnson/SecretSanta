    ...
    protected async override Task<ICommandResult<TItem>> HandlePostValidation()
    {
        ...
        if (globalUserId != null)
        {
            ...
            if (dbCurrentUser != null)
            {
                ...
                dbCurrentUser.SecurityAnswer1 = EncryptionHelper.OneWayEncrypt(Item.SecurityAnswer1?.Trim().ToLower() ?? string.Empty, dbCurrentUser);
                ...
                dbCurrentUser.SecurityAnswer2 = EncryptionHelper.OneWayEncrypt(Item.SecurityAnswer2?.Trim().ToLower() ?? string.Empty, dbCurrentUser);
