...
namespace Data.Migrations
{
    ...
    [Migration("20260314143731_RemoveUnnecessaryDeletedColumns")]
    partial class RemoveUnnecessaryDeletedColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data.Entities.Santa.Santa_Message", b =>
                {
                    ...
                    b.Property<int?>("ReplyToMessageKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Entities.Santa.Santa_User", b =>
                {
                    ...
                    b.Property<bool>("DetailedEmails")
                        .HasColumnType("bit");

                    b.Property<string>("GlobalUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("ReceiveEmails")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Entities.Santa.Santa_Message", b =>
                {
                    ...
                    b.HasOne("Data.Entities.Santa.Santa_Message", "OriginalMessage")
                        .WithMany("RepliesToReplies")
                        .HasForeignKey("OriginalMessageKey")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Data.Entities.Santa.Santa_Message", "ReplyToMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ReplyToMessageKey")
                        .OnDelete(DeleteBehavior.Restrict);
